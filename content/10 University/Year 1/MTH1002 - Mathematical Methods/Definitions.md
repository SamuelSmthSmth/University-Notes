...
> They each have [[Definitions#Length of a vector|norm]] 1 and point in the directions of the $x, y$ and $z$-axes respectively.
...
### Inverse Function
> An *inverse* ([[Definitions#Function|function]]) to a function $f : A \to B$ is a function $g : B \to A$: $$g \circ f = id_A \text{ and } f \circ g = id_B$$
